...
This guide goes into detail on how to set up a Proof of Stake network with Lyfebloc Network, how to stake funds for nodes
...
Setting up a network with Lyfebloc Network is covered in
the [Local Setup](/docs/get-started/set-up-ibft-locally)
