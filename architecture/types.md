...
Unlike clients such as GETH, Lyfebloc Network doesn't use reflection for the encoding.<br />
...
By manually defining these methods, Lyfebloc Network doesn't need to use reflection. In *rlp_marshal.go*, you can find
